...
public class AgentHandle {
     ...
     * @return
     */
    public Operation agentSetScriptedDestination(PosVariable position,Variable autoSetZToGroundLevel){
        return new AgentSetScriptedDestination(this.variable,position.getVar(),autoSetZToGroundLevel);
    }
     ...
     * @return
     */
    public Operation agentIsWounded(){
     ...
     * @return
     */
    public Operation agentSetPosition(PosVariable position){
        return new AgentSetPosition(this.variable,position.getVar());
    }
     ...
     * @return
     */
    public Operation agentHasItemEquipped(Item item){
     ...
     * @return
     */
    public Operation agentGetPosition(PosVariable position){
        return new AgentGetPosition(position.getVar(),this.variable);
    }
     ...
     * @return
     */
    public Operation agentSetSpeedLimit(Variable speedLimit){
        return new AgentSetSpeedLimit(this.variable,speedLimit);
    }
     ...
     * @return
     */
    public Operation strStoreAgentName(SregVariable stringRegister){
        return new StrStoreAgentName(stringRegister.getVar(),this.variable);
    }
     ...
     * @return
     */
    public Operation agentGetLookPosition(PosVariable position){
        return new AgentGetLookPosition(position.getVar(),this.variable);
    }
     ...
     * @return
     */
    public Operation agentGetScriptedDestination(PosVariable position){
        return new AgentGetScriptedDestination(position.getVar(),this.variable);
    }
     ...
     * @return
     */
    public Operation agentIsDefender(){
