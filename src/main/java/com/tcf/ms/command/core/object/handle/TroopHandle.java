...
import com.tcf.ms.command.core.operation.TroopSetSlot;
...
import com.tcf.ms.command.core.operation.TroopSlotEq;
...
import com.tcf.ms.command.core.operation.TroopSlotGe;
...
import com.tcf.ms.command.core.operation.TroopGetSlot;
...
public class TroopHandle {
     ...
     * @return
     */
    public Conditable troopIsGuaranteeRanged(){
     ...
     * @return
     */
    public Operation strStoreTroopNamePlural(Variable stringRegister){
        return new StrStoreTroopNamePlural(stringRegister,this.variable);
    }
     ...
     * @return
     */
    public Operation troopLootTroop(Variable targetTroop,Variable sourceTroopId,Variable probability){
     ...
     * @return
     */
    public static Conditable troopsCanJoin(Variable value){
     ...
     * @return
     */
    public Operation strStoreTroopName(Variable stringRegister){
        return new StrStoreTroopName(stringRegister,this.variable);
    }
     ...
     * @return
     */
    public Operation troopGetSlot(Variable destination,Variable slotNo){
        return new TroopGetSlot(destination,this.variable,slotNo);
    }
     ...
     * @return
     */
    public Conditable troopIsWounded(){
     ...
     * @return
     */
    public Conditable troopIsGuaranteeHorse(){
     ...
     * @return
     */
    public Conditable troopIsMounted(){
     ...
     * @return
     */
    public Conditable troopSlotEq(Variable slotNo,Variable value){
        return new TroopSlotEq(this.variable,slotNo,value);
    }
     ...
     * @return
     */
    public Conditable troopSlotGe(Variable slotNo,Variable value){
        return new TroopSlotGe(this.variable,slotNo,value);
    }
     ...
     * @return
     */
    public Operation curTableauAddTroop(Variable positionNo,Animation animation,Variable instanceNo){
        return new CurTableauAddTroop(this.variable,positionNo,animation.getVar(),instanceNo);
    }
     ...
     * @return
     */
    public Conditable troopHasItemEquipped(Item item){
     ...
     * @return
     */
    public Operation strStoreTroopNameLink(Variable stringRegister){
        return new StrStoreTroopNameLink(stringRegister,this.variable);
    }
     ...
     * @return
     */
    public Operation troopSetSlot(Variable slotNo,Variable value){
        return new TroopSetSlot(this.variable,slotNo,value);
    }
     ...
     * @return
     */
    public static Conditable troopsCanJoinAsPrisoner(Variable value){
     ...
     * @return
     */
    public Operation strStoreTroopNameByCount(Variable stringRegister,Variable number){
        return new StrStoreTroopNameByCount(stringRegister,this.variable,number);
    }
