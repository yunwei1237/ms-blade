...
import com.tcf.ms.command.core.operation.PartyGetSlot;
...
import com.tcf.ms.command.core.operation.PartySetSlot;
...
import com.tcf.ms.command.core.operation.PartySlotEq;
import com.tcf.ms.command.core.operation.PartyAttachToParty;
import com.tcf.ms.command.core.operation.PartySlotGe;
...
public class PartyHandle {
     ...
     * @return
     */
    public Operation strStorePartyName(Variable stringRegister){
        return new StrStorePartyName(stringRegister,this.variable);
    }
     ...
     * @return
     */
    public Operation partySetPosition(Variable positionNo){
        return new PartySetPosition(this.variable,positionNo);
    }
     ...
     * @return
     */
    public Operation partyGetPosition(Variable positionNo){
        return new PartyGetPosition(positionNo,this.variable);
    }
     ...
     * @return
     */
    public Operation partyGetAiTargetPosition(Variable positionNo){
        return new PartyGetAiTargetPosition(positionNo,this.variable);
    }
     ...
     * @return
     */
    public Operation partySetExtraText(GameString string){
        return new PartySetExtraText(this.variable,string.getVar());
    }
     ...
     * @return
     */
    public Operation strStorePartyNameLink(Variable stringRegister){
        return new StrStorePartyNameLink(stringRegister,this.variable);
    }
     ...
     * @return
     */
    public Operation partySetSlot(Variable slotNo,Variable value){
        return new PartySetSlot(this.variable,slotNo,value);
    }
     ...
     * @return
     */
    public Operation storeDistanceToPartyFromParty(Variable destination){
        return new StoreDistanceToPartyFromParty(destination,this.variable,this.variable);
    }
     ...
     * @return
     */
    public Operation partyGetSlot(Variable destination,Variable slotNo){
        return new PartyGetSlot(destination,this.variable,slotNo);
    }
     ...
     * @return
     */
    public Operation partySetAiObject(){
        return new PartySetAiObject(this.variable,this.variable);
    }
     ...
     * @return
     */
    public Operation inflictCasualtiesToPartyGroup(Variable parentPartyId,Variable attackRounds,Variable partyIdToAddCausaltiesTo){
     ...
     * @return
     */
    public Conditable partyIsInTown(Variable partyId1,Variable partyId2){
     ...
     * @return
     */
    public Conditable partyCanJoinParty(Variable joinerPartyId,Variable hostPartyId,Variable flipPrisoners){
     ...
     * @return
     */
    public Conditable partySlotEq(Variable slotNo,Variable value){
        return new PartySlotEq(this.variable,slotNo,value);
    }
     ...
     * @return
     */
    public Conditable partyIsActive(){
     ...
     * @return
     */
    public Operation partySetAiTargetPosition(Variable positionNo){
        return new PartySetAiTargetPosition(this.variable,positionNo);
    }
     ...
     * @return
     */
    public Conditable partySlotGe(Variable slotNo,Variable value){
        return new PartySlotGe(this.variable,slotNo,value);
    }
