...
public class OverlayAnimateToAlpha implements Operation {
    ...
    public OverlayAnimateToAlpha(Variable overlayId, Variable duration, Variable alpha) {
    ...
    public String toScriptString() {
        return String.format("(overlay_animate_to_alpha,%s,%s,%s),",overlayId,duration,alpha);
    }
}
