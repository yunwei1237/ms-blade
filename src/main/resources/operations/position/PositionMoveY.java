...
public class PositionMoveY implements Operation {
    ...
    public PositionMoveY(Variable positionNo, Variable movement) {
    ...
    public String toScriptString() {
        return Objects.isNull(value) ? String.format("(position_move_y,%s,%s),",positionNo,movement) : String.format("(position_move_x,%s,%s,%s),",positionNo,movement,value);
    }
}
