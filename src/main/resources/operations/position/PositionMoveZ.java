...
public class PositionMoveZ implements Operation {
    ...
    public PositionMoveZ(Variable positionNo, Variable movement) {
    ...
    public String toScriptString() {
        return Objects.isNull(value) ? String.format("(position_move_z,%s,%s),",positionNo,movement) : String.format("(position_move_x,%s,%s,%s),",positionNo,movement,value);
    }
}
