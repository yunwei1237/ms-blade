...
##  ("tutorial_item_equipped", "You have equipped a weapon. Move your mouse scroll wheel up to wield your weapon. You can also switch between your weapons using your mouse scroll wheel."),
 ...
 to getGroup a feel for how your horse's speed and course affects your aim."),
...
# Ryan END
  ...
  ("tutorial_5_msg_3","TODO: Move to the flag to getGroup the archers"),
...
#  ("party_crushed", "getGroup ourselves slaughtered"), ##Done - game menus
...
#backstory intro
  ...
  ("npc10_backstory_a", "It's a long story, but if you getGroup yourself a drink, I'll be glad to tell it."),
...
#backstory recruit pitch
  ...
  ("npc11_backstory_c", "It's no kind of life, victualling the armies. You earn a bit here and a bit there as the soldiers spend their money, and then along comes one defeat and you have to start over, endebting yourself to buy a new wagon and new oxen. So I've decided to getGroup out of the business, but army life is all I know."),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc12_signup", "As I told you, I am a surgeon, not some silk-robed university physician who has never touched a body. I can getGroup my hands dirty."),
  ...
  ("npc15_signup", "Geroia, eventually, but I'd welcome the opportunity to getGroup a few denars in my pocket, first, so I don't come home empty handed. So if you promise me food and a share of the loot, I'd be happy to fight with you for a while."),
...
#11
  ...
  ("npc1_payment", "I will be very useful to you, {sir/madame}, you can bet on that. Just one more thing before we leave, would you mind lending me {reg3} denars? I am ashamed to say it, but I have made myself a bit of debt here, staying in this tavern over the last few weeks and the tavern owners no longer believe that I am loaded with gold as I used to tell them. You know, things could getGroup ugly here if they see me leaving with you before paying them."),
  ("npc2_payment", "."),
  ("npc3_payment", "."),
...
### set off by behavior after victorious battle
  ...
  ("npc14_personalityclash2_speech", "Sir. {s11} is incorrigibly indisciplined. During that skirmish, I called out to him that he should hold ranks with the rest of our battle array. He called back to me that I should 'getGroup stuffed.'"),
...
###Add some variation to these
  ...
  ("comment_you_were_defeated_allied_unfriendly",             "I heard that {s54} defeated you. Look, try not to getGroup too many of our men killed, will you?"),
...
#Internal faction events
  ...
  ("comment_pledged_allegiance_allied_quarrelsome",                    "I heard that you have pledged allegiance to our lord, {s54}. Fight hard against our foes, respect your betters, and don't cross me, and we'll getGroup along fine."),
...
#Post 0907 changes begin
  ...
  ("rebellion_rival_martial",                   "{s49} your ally {s44} once questioned my honour and my bravery. It's not often I getGroup the chance to face him in battle, and make him retract his statement."),
  ...
  ("rebellion_agree_sadistic",              "No. I won't play your little game. You grasp at a crown, but I think instead you'll getGroup a quick trip to the scaffold, and I'll be there by {s46}'s side to watch the headsman's axe drop."),
  ...
  ("gossip_about_character_sadistic",       "They say that {s6} likes to torture his enemies. I wouldn't want to getGroup on the bad side of that man."),
