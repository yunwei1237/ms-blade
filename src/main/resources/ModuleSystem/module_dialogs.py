...
#                       (this_or_next|eq, "$talk_context", tc_castle_commander),
 ...
 but your average rabble-rouser will bleed like a stuck pig if you getGroup him with something sharp. I don't have many requirements in my merchandise,\
 ...
 rather than cutting him open with a sword. That way he goes to sleep for a little while rather than bleeding to death, you see?\
 It's a bit different for nobles and such, they tend to be protected enough that it won't matter what kind of weapon you use,\
 but your average rabble-rouser will bleed like a stuck pig if you getGroup him with something sharp.", "ramun_ask_about_capturing_2",[]],
...
## I pray to God you will kill them all.", "close_window",[(assign, "$g_leave_encounter",1)]],
  ...
  [party_tpl|pt_manhunters,"manhunter_talk_b1", [], "I knew it! Come on, lads, lets go getGroup these bastards! Thanks a lot, friend.", "close_window",[(assign, "$g_leave_encounter",1)]],
...
#Quest heroes member chats
  ...
  [trp_kidnapped_girl,"kidnapped_girl_chat_2", [], "I can't wait to getGroup back. I've missed my family so much, I'd give anything to see them again.", "close_window",[]],
...
### If the companion and the player were separated in battle
  [anyone, "start", [(is_between, "$g_talk_troop", companions_begin, companions_end),
   ...
   "It is good to see you alive, {s5}! {s6}, and I did not know whether you had been captured, or slain, or got away. I've been roaming around since then, looking for you. Shall I getGroup my gear together and rejoin your company?",
   "companion_rehire", [
...
##
 ...
 I can see you're not afraid to getGroup your hands dirty, eh? I like that in a {man/woman}.\
 ...
 Here, this is half the money I promised you. Don't say a word, {playername}, you're lucky to getGroup even that.\
...
##  [anyone|plyr,"quest_hunt_down_raiders_failed", [],  "They were too quick for us my lord. But next time we'll getGroup them", "quest_hunt_down_raiders_failed_2",[]],
...
#     (call_script, "script_troop_add_gold", "trp_player", 100),
  ...
  [anyone, "lord_start",
   ...
   "The army's supplies are dwindling too quickly, {playername}. I need you to bring me {reg3} heads of cattle so I can keep the troops fed. I care very little about where you getGroup them, just bring them to me as soon as you can.", "lord_mission_told_deliver_cattle_to_army",
   [
   ]
   ],
  ...
  [anyone,"lord_mission_told_deliver_cattle_to_army_accepted", [], "Excellent! You know what to do, {playername}, now getGroup to it. I need that cattle sooner rather than later.", "close_window",
   [
...
## It is the nature of this world {playername}. Everyone should know their place.", "lord_pretalk", []],
 ...
 I can pay you {reg6} denars for him if you want to getGroup rid of him.\
...
", "lord_buy_prisoner", []],
 ...
 I'll send some men to take him to our prison with due haste.", "lord_pretalk", [
  ...
  [anyone,"lord_buy_prisoner_deny", [],
   "Mmm. As you wish, {playername}, but you'll not getGroup a better offer. Take it from me.", "lord_pretalk", []],
...
##
 ...
 With some luck they'll soon getGroup so drunk they'd have trouble\
...
##   "What? Do I look like I am running an inn here? I have no place here for {reg7?you and your lot:you}. Now getGroup off my lands...", "close_window",[(assign, "$g_permitted_to_center",1)]],
...
##   "Of course {playername}. You are welcome here. You may rest at {s1} as long as you wish.", "close_window",[(assign, "$g_permitted_to_center",1)]],
  ...
  [anyone,"lord_ask_pardon_terms_rejected",
   [], "Then getGroup out of my sight, traitor! Begone with you, and do not come back!", "close_window",
   [
     (assign, "$g_leave_encounter", 1),
...
##
 ...
 You have let them getGroup away with murder as well as my money. What a farce!\
...
#Hunt down fugitive
 ...
 I can't let him getGroup away with avoiding justice, so I've put a bounty of 300 denars on his head.\
 ...
 And of course the bounty on his head will be yours if you can getGroup him.\
...
I suppose there are plenty of bounty hunters around to getGroup the job done . . .", "lord_pretalk",
   [(troop_set_slot, "$g_talk_troop", slot_troop_does_not_give_quest, 1)]],
...
##
 ...
 Dispose of him for me and I shall reward you generously.", "close_window",
  ...
  [anyone|plyr,"quest_meet_spy_in_enemy_town_accepted_response", [(quest_get_slot, ":quest_target_center", "$random_quest_no", slot_quest_target_center),
                                                                  (str_store_party_name_link, s13, ":quest_target_center")],
   "{s13} is heavily defended. How can I getGroup close without being noticed?", "quest_meet_spy_in_enemy_town_accepted_2",
   []],
 ...
 Now they getGroup stronger with each passing and their arrogance knows no bounds.\
 ...
 They are already looking for an excuse to getGroup at me, and if I did this they could make me pay for it dearly.\
 You, on the other hand, are young and well liked and daring, so you might just getGroup away with it.\
 ...
 Now, don't forget that you must capture and loot at least {reg13} caravans to make sure that those fools in {s13} getGroup really infuriated.\
 ...
 if we could only getGroup our hands on him...", "lord_tell_mission_follow_spy",[]],
 ...
 so you will know the man to follow. Remember, I want them both, and I want them alive.", "close_window",
   [
     ...
     (setup_quest_text, "$random_quest_no"),
     (str_store_string, s2, "@{s11} asked you to follow the spy that will leave {s12}. Be careful not to let the spy see you on the way, or he may getGroup suspicious and turn back. Once the spy meets with his accomplice, you are to capture them and bring them back to {s11}."),
     (call_script, "script_start_quest", "$random_quest_no", "$g_talk_troop"),
     #TODO: Change this value
     (call_script, "script_change_player_relation_with_troop", "$g_talk_troop", 1),
...
##
 ...
 So I need to getGroup {s15} out of the picture, and I have a plan just to do that...\
 ...
 They'll torture your man, of course, to try and getGroup the truth out of him,\
...
##
 ...
 Instead I came up with a plan to getGroup him out of there, but it requires someone to make a great sacrifice,\
 ...
 but the journey is so dangerous that we getGroup little chance to do so.\
...
#Leave
  ...
  [anyone|plyr,"lady_restore_relation_2", [], "Never mind. I getGroup along with everyone well enough.", "lady_pretalk",[]],
...
#Convincing bargaining
 ...
 and let me assure you you'll getGroup none.", "lord_pretalk",[]],
...
### Troop commentaries changes end
  ...
  [anyone,"merchant_attack", [], "Damn you, you won't getGroup anything from us without a fight!", "close_window",
   [(store_relation,":rel", "$g_encountered_party_faction","fac_player_supporters_faction"),
    (try_begin),
      (gt, ":rel", 0),
      (val_sub, ":rel", 10),
...
### Troop commentaries changes end
 ...
 We'll need your help if we getGroup ambushed by bandits.", "caravan_offer_protection_5",[]],
  ...
  [anyone,"caravan_offer_protection_6", [(get_party_ai_object,":caravan_destination","$g_encountered_party"),
    (str_store_party_name,1,":caravan_destination")],
   "Good. Come and collect your money when we're within sight of {s1}. For now, let's just getGroup underway.", "close_window",
   [(get_party_ai_object,":caravan_destination","$g_encountered_party"),
...
# Prison Guards
  ...
  [anyone,"prison_guard_visit_prison", [],
   "You need to getGroup permission from the lord to talk to prisoners.", "prison_guard_visit_prison_2",[]],
...
# Castle Guards
 ...
 Beggars are not allowed into the hall. Now getGroup lost or I'll beat you bloody.", "close_window",[]],
...
#Spy
  ...
  [anyone, "follow_spy_talk_2", [], "You won't getGroup me alive!", "close_window", []],
...
##
##  [anyone,"conspirator_talk_2", [], "You won't getGroup me alive!", "close_window",[]],
##
#Runaway Peasants
...
##                                 (gt, ":num_deserters", 1)],
##   "If you surrender to me now, you will rejoin the army of your kingdom without being punished. Otherwise you'll getGroup a taste of my sword.", "deserter_join_as_prisoner",[]],
...
#Tavern Talk (with ransom brokers)
  ...
  [anyone,"start", [(is_between, "$g_talk_troop", ransom_brokers_begin, ransom_brokers_end),
                    (eq, "$g_talk_troop_met", 0)],
   "Greetings to you, {sir/madam}. You look like someone who should getGroup to know me.", "ransom_broker_intro",[]],
 ...
 One cannot do Heaven's work with an empty purse, you see.", "ransom_broker_info_talk",[(assign, "$ransom_broker_families_told",1)]],
  [anyone|plyr,"ransom_broker_info_talk",[(eq, "$ransom_broker_prices_told",0)], "What can I getGroup for a prisoner?", "ransom_broker_prices",[]],
...
#Tavern Talk (with travelers)
 ...
 A vassal can own villages, castles and towns and getGroup rich with the taxes and revenues of these estates.\
...
#Trainers
 ...
 "That was a good fight. ", "trainer_practice_1",
  ...
  [anyone,"start", [(is_between, "$g_talk_troop", training_gound_trainers_begin, training_gound_trainers_end),
                    (neq, "$waiting_for_training_fight_result", 0)],
 "Ha! Looks like you've developed a bit of a limp there. Don't worry, even losses have their value, provided you learn from them. Shake the stars out of your eyes and getGroup back in there. There's no other way to win.", "trainer_practice_1",
...
## The easiest way to make money is to fight in the tournaments and bet on yourself. If you are good, you'll quickly getGroup yourself enough money to getGroup going.", "crook_talk",[]],
##
...
#Mayor talk (town elder)
  ...
  [anyone,"mayor_begin", [(check_quest_active, "qst_persuade_lords_to_make_peace"),
   ...
   "{playername}, it was an incredible feat to getGroup {s14} and {s15} make peace, and you made it happen.\
...
# Kidnapped girl:
 ...
 Those bastards said that they are going to kill the poor girl if they don't getGroup the money by that time.\
 You will getGroup your pay of {reg8} denars when you bring the girl safely back here.",
 ...
 It was a pleasure doing business with you...", "close_window",
  ...
  [anyone,"bandits_awaiting_remeet_2", [],
   "Oh, that business! Of course. Let us getGroup down to it.", "close_window",[(encounter_attack)]],
...
#persuade_lords_to_make_peace
 ...
 Our caravans getGroup raided before they can reach their destination.\
...
#deal with night bandits
 ...
 You can expect a fine reward if you come back successful. Just don't getGroup yourself killed, eh?", "mayor_pretalk",[]],
...
#############################################################################
 ...
 Except, there is an official duel every now and then, and  of course we have melee fights almost every day.", "arena_intro_3",[]],
  ...
  [anyone,"arena_training_melee_intro", [], "The fighters and knights getGroup bored waiting for the next tournament,\
 ...
 If you can beat {reg1} opponents before going down, you'll earn {reg11} denars. You'll getGroup {reg12} denars for striking down at least {reg2} opponents,\
...
# "That was exciting wasn't it? Nothing like a good fight to getGroup the blood flowing.", "arena_master_pre_talk",[(assign,"$waiting_for_arena_fight_result",0)]],
...
##  [anyone,"arena_master_bet_placed", [(eq,"$arena_join_or_watch",1)], "Hmm. That's good. If you win, you'll getGroup {reg5} denars. And which team do you want to place your bet on?", "arena_master_select_team",
...
##  [anyone,"arena_master_bet_placed", [], "That's good. Let me record that. If you win, you'll getGroup {reg5} denars.", "arena_master_start_fight",
##   [(store_mul,"$arena_win_amount", "$arena_bet_amount", "$_num_teams"),
##    (party_get_slot, ":player_odds", "$g_encountered_party", slot_town_player_odds),
...
##   "Venture deep into the enemy territory and find myself a caravan to raid. That's the way I will getGroup rich.", "close_window",[(assign, "$g_leave_encounter",1)]],
##
...
# Ryan BEGIN
  ...
  [anyone,"bandit_introduce", [
      (store_random_in_range, ":rand", 11, 15),
        ...
        (str_store_string, s12, "@Why, it be another traveller, chance met upon the road! I should warn you, country here's a mite dangerous for a good {fellow/woman} like you. But for a small donation my boys and I'll make sure you getGroup rightways to your destination, eh?"),
 ...
 Forget it. You gave us no quarter, and you'll getGroup none from us.", "close_window",[]],
