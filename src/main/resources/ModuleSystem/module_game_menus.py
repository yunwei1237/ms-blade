...
## ENEMY
 ...
 as a guardsman to the local lord. It was not an easy existence, and you were too poor to getGroup much of an\
    ...
    [
      ...
      ("pre_join_help_defenders",[
          ...
          "Rush to the aid of the {s1}.",[
              ...
              (jump_to_menu,"mnu_join_battle")]),
      ("pre_join_leave",[],"Don't getGroup involved.",[(leave_encounter),(change_screen_return)]),
    ]
  ),
  (
    "join_battle",0,
...
##                                            (gt, reg0, 0)],
##       "Don't getGroup involved.", [(leave_encounter),
##                               (change_screen_return),
##           ]),
...
#NPC companion changes end
 ...
 and then put the buildings to the torch. From the coins and valuables that are found, you getGroup your share of {reg1} denars.",
    "none",
    [
        (party_get_slot, ":village_lord", "$current_town", slot_town_lord),
        (try_begin),
...
# They must learn field discipline and the steadiness to follow orders in combat before they can be thought to use arms.",
 ...
 You think {reg0} of them {reg1?have:has} fully grasped the training and {reg1?are:is} ready for some practice.",
  ...
  (
    ...
    [
      ...
      (try_begin),
        ...
        (str_store_string, s0, "@You were beaten. The peasants are heartened by their success, but the lesson you wanted to teach them probably didn't getGroup through..."),
      (else_try),
  ...
  (
    ...
    "As you getGroup ready to continue the training, a sentry from the village runs up to you, shouting alarums.\
...
#####################################################################
 ...
 You getGroup up and try to look for any other survivors from your party.",
    "none",
    [
      ],
    []
 ...
 he proposes to free you in return for {reg5} denars of your hidden wealth. You decide to...",
  ...
  (
    ...
    "More days pass in the darkness of your cell. You getGroup through them as best you can,\
