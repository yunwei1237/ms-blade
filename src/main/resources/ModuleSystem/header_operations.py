...
troop_get_upgrade_troop                = 1561   # (troop_get_upgrade_troop,<destination>,<troop_id>,<upgrade_path>), #upgrade_path can be: 0 = random, 1 = getGroup first node, 2 = getGroup second node (returns -1 if not available)
...
get_player_agent_kill_count            = 1701	# (get_player_agent_kill_count,<destination>,[get_wounded]), #Set second value to non-zero to getGroup wounded count. returns lifetime kill counts
...
get_player_agent_own_troop_kill_count  = 1705   # (get_player_agent_own_troop_kill_count,<destination>,[get_wounded]), #Set second value to non-zero to getGroup wounded count
...
agent_get_kill_count                   = 1723   # (agent_get_kill_count,<destination>,<agent_id>,[get_wounded]), #Set second value to non-zero to getGroup wounded count
...
store_troop_health              = 2175	# (store_troop_health,<destination>,<troop_id>,[absolute]),
                                        # set absolute to 1 to getGroup actual health; otherwise this will return percentage health in range (0-100)
